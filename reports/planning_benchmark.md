...
| 约束排程（关闭历史） | 100.0% | 0 | 100.0% | 2.8% | 95.5% | 9350 |
| 完整策略（最小扰动） | 100.0% | 0 | 100.0% | 72.2% | 0.0% | 1225 |
...
| `R02_morning_meeting` | minimal_disruption | 是 | 0 | 2 | 770 |
| `R03_opening_delayed` | opening_hours | 是 | 0 | 2 | 1160 |
| `R04_rain_boundary` | weather | 是 | 0 | 2 | 1030 |
| `R05_new_urgent_task` | deadline | 是 | 0 | 3 | 600 |
| `R06_duration_expansion` | minimal_disruption | 是 | 0 | 2 | 680 |
| `R07_activity_window_shift` | activity_window | 是 | 0 | 2 | 710 |
| `R08_route_time_changed` | travel | 是 | 0 | 1 | 750 |
...
| `R03_opening_delayed` | opening_hours | 是 | 0 | 0 | 370 |
